...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://dl.dropbox.com/s/xjrdgu1qxnrcfu5/WinServer2019.iso
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://dl.dropbox.com/s/xjrdgu1qxnrcfu5/WinServer2019.iso
else
